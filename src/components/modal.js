            ...
            <div id='modalBG' onClick={() => this.hideModal()}>
                ...
                <div id='modalDiv'>
                    <span id='modalLinkSpan'>This&nbsp;
                        <a className='modalLink' href={imageLink} target='_blank' rel='noreferrer' onClick={(e)=>{e.stopPropagation()}}>Photo</a> 
                        &nbsp;was taken by&nbsp; 
                        <a className='modalLink' href={imageArtistLink} target='_blank' rel='noreferrer' onClick={(e)=>{e.stopPropagation()}}>{imageArtist}</a> 
                        &nbsp;on&nbsp;
                        <a className='modalLink' href='https://www.pexels.com' target='_blank' rel='noreferrer' onClick={(e)=>{e.stopPropagation()}}>Pexels</a>
                    </span>
                </div>
            </div>
        );
